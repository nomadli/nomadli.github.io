...
20. #pragma unroll(4) 告诉编译器下面的循环可以展开四层即for(){a[i]=x;}变为for(){a[i]=x;a[i+1]=x;...}-O1,-O2,-O3则无效
21. #pragma MUST_INTERAT(1)不要进行循环展开
22. \#pragma mark -  代码分类
23. \#pragma clang diagnostic push clang参数压栈
24. \#pragma clang diagnostic pop clang参数出栈
25. \#pragma clang diagnostic warning "-W*" 添加警告
26. \#pragma clang diagnostic ignored "-W*" 取消某警告 文章末尾列表
27. \#pragma clang assume_nonnull begin
28. \#pragma clang assume_nonnull end
29. __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__ | __ORDER_BIG_ENDIAN__
```
#ifdef __clang__
