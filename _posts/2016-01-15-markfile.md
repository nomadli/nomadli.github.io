...
```make
        ...
        xcodebuild IPHONEOS_DEPLOYMENT_TARGET=8.0 ARCHS=[arm64,arm64e,armv7,armv7s,i386,x86_64] -sdk [iphoneos iphonesimulator] -configuration Release -jobs 4 -target ALL_BUILD build
        mkdir x.framework
        pushd x.framework
                mkdir -p ./Versions/A/Headers
                mkdir -p ./Versions/A/Resources
                cp -R ../arm64/include/dlib/* ./Versions/A/Headers/
                cp ../Info.plist ./Versions/A/Resources/
                lipo -create ../arm64/lib/xx.a ../xx/lib/xx.a . -o ./Versions/A/xx
        popd
        ...
        pushd x.framework
                ln -s ../x.framework/Versions/Current/Headers ../x.framework/Headers
                ln -s ../x.framework/Versions/Current/Resources ../x.framework/Resources
                ln -s ../x.framework/Versions/Current/libdlib ../x.framework/libdlib
        popd
```
