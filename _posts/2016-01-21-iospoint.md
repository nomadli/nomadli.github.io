...
07. 服务器推送签名导出
    openssl x509 -in addDevceDown.cer -inform DER -out addDevceDown.pem -outform PEM  
    openssl pkcs12 -nocerts -in keychianexport.p12 -out keychianexport.pem  
    openssl pkcs12 -export -inkey keychianexport.pem -in addDevceDown.pem -out server.p12
08.
