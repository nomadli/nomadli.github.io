...
## Apple 信息
- [商务管理](https://business.apple.com)
- [企业功能管理](https://register.apple.com)
- [开发者](https://developer.apple.com)
- [商店管理](https://appstoreconnect.apple.com)
- [云存储管理](https://icloud.developer.apple.com)
- [AI模型管理](https://ml.developer.apple.com)
- [苹果开源1](https://github.com/apple-oss-distributions)
- [苹果开源2](https://opensource.apple.com)
- 上海梦回科技有限公司 Shanghai Menghui Technology Co., Ltd.
- 上海市浦东新区南汇新城镇环湖西二路888号C楼 200120
- Building C, No.888 Huanhu West Second Road, Nanhui New Town, Pudong New District, Shanghai
- shang hai meng hui ke ji you xian gong si
- https://nomadli79.github.io
- D-U-N-S：554523681
...
## 模拟器
- xcrun simctl list devices 显示模拟器列表
- xcrun simctl boot <device_udid> 运行某模拟器
- xcrun simctl install <device_udid> ~/xx.app 安装 可以直接拖上去安装
- xcrun simctl launch <device_udid> x.x.x
...
- [安全相关如检测是否重签名](https://developer.apple.com/documentation/security)
...
## 系统参数
- CFNetworkCopySystemProxySettings 获取网络代理配置
