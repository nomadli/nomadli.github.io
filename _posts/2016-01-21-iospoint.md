...
7. breakpoint set -r . -s <PRODUCT_NAME> 在指定项目中正则设置断点
8. breakpoint set -n name 在指定名称上设置断点
9. breakpoint set -S alignLeftEdges: 指定参数名设置断点
10. breakpoint set -l num -f filename
11. breakpoint set -a mem_address
12. breakpoint set -F functionname
13. breakpoint xx -o condition
14. breakpoint xx -i ignone_times
15.  breakpoint clear -l num -f filename
