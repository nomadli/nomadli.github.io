...
fdisk -l|查看当前磁盘分区
command+R csrutil disable enable|禁启用安全限制
networksetup -listallnetworkservices|显示所有网络设备
networksetup -setadditionalroutes "出口设备名" <171.0.0.0 255.0.0.0 出口网关ip> [.. .. ..]... 设置路由
...
sudo xattr -r -d com.apple.quarantine xxx.app  |   codesign -f -s - --deep xxx.app
