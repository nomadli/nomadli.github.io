...
39. rz sz 上传下载工具
40. strings /lib64/libc.so.6 |grep GLIBC_ 查看已装版本
41. rpm -qa |grep glibc 查看已装版本
42. ldconfig -l -v /lib64/libc-2.5.so 创建软连接
43. LD_PRELOAD=/lib64/libc-2.12.so ln -s /lib64/libc-2.12.so /lib64/libc.so.6
...
## 补丁
- diff -Naur 1/src/ 2/src/ > change.patch 
