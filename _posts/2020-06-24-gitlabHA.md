...
- gitlab-runner
    - /etc/gitlab-runner/config.toml
        - concurrent = 1        服务agent个数
        - check_interval = 0    检测agent间隔
