...
sed -i -e 's/PRODUCT_BUNDLE_IDENTIFIER = .*/PRODUCT_BUNDLE_IDENTIFIER = com.nomadli.financial;/g' ${WORKSPACE}/EMBroker.xcodeproj/project.pbxproj
...
sed -i -e 's/CODE_SIGN_IDENTITY = .*/CODE_SIGN_IDENTITY = "iPhone Distribution: nomadli Information Co.,Ltd.";/g' ${WORKSPACE}/EMBroker.xcodeproj/project.pbxproj
sed -i -e 's/"CODE_SIGN_IDENTITY\[sdk=iphoneos\*\]" = .*/"CODE_SIGN_IDENTITY\[sdk=iphoneos\*\]" = "iPhone Distribution: nomadli Information Co.,Ltd.";/g' ${WORKSPACE}/EMBroker.xcodeproj/project.pbxproj
...
/usr/bin/xcodebuild -exportArchive -archivePath "${archivefilePath}" -exportPath "${ipafilePath}" -exportOptionsPlist "${exportOptionsPath}" CODE_SIGN_IDENTITY="iPhone Distribution: nomadli Information Co.,Ltd." PROVISIONING_PROFILE="12345-123-234-432-12345676"
