...
09. -test.benchtime t : 性能测试运行的时间，默认是1s
...
3. +build !static +build static_all  
4. \#cgo pkg-config: --static libname
5. \#cgo LDFLAGS: -static -llibnmae -Wl -Bstatic -Bdynamic -L..
6. 文件名约束 xx_linux.go xx_windows_amd64.go 
7. +build linux,386 darwin,!cgo 
8. \#cgo [darwin linux windows] CFLAGS: -I ${SRCDIR}/...
